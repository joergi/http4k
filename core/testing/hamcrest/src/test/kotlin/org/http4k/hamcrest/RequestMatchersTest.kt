...
class RequestMatchersTest {
    ...
    @Test
    fun `form as matcher`() = assertMatchAndNonMatch(Request(GET, "/").form("form", "bob"), hasForm("form", containsString("bob")), hasForm("form", equalTo("bill")))
    ...
    @Test
    fun `query - matcher`() = assertMatchAndNonMatch(Request(GET, "/bob?form=bob"), hasQuery("form", equalTo("bob")), hasQuery("form", containsString("bill")))
